  ...
  return (
    <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[30rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="p-4  bg-white sticky bottom-0"> 
            <button className="w-full bg-black py-3 text-white rounded-lg font-semibold hover:bg-gray-800 transition">
                Checkout
            </button>
            <p className="text-sm tracking-tighter text-gray-600 mt-2 text-center">Shipping, taxes and discount codes calculated at chekout.</p>
        </div>
    </div>
  )
}
